                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (textController1.text.trim() != null
                                        ...
                                        await FirebaseFirestore.instance.collection('réclamation_park').add({
                                          "discrition": textController1.text.trim(),
                                          "parking": _selectedLocation.trim(),
                                          "date": dateinput1.text.trim(),
                                          "type": _type,

                                        });

                                        Navigator.of(context).pop();
                                        Map<String,dynamic>data={  "discrition": textController1.text.trim(),
                                          "parking": _selectedLocation,
                                          "date": dateinput1.text,
                                          "type": _type,
                                        };
                                        FirebaseFirestore.instance.collection("réclamation_park").add(data);
